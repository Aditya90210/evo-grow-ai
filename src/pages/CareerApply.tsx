...
const jobs = [
  ...
  { slug: "product-manager", title: "Product Manager", location: "San Francisco, CA", type: "Full-time", department: "Product", description: "Join our product team to drive the roadmap for EVO Grow's core platform. You'll work closely with engineering, design, and customers to deliver features that make a real impact." },
  { slug: "customer-success-manager", title: "Customer Success Manager", location: "Remote", type: "Full-time", department: "Customer Success", description: "Help our customers get the most out of EVO Grow. You'll be the primary point of contact for enterprise clients, ensuring their success and satisfaction." },
