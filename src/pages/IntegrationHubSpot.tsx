      ...
      <main className="pt-24 pb-16">
        <div className="container px-4">
          ...
          <div className="max-w-4xl">
            <span className="text-xs text-primary font-medium">Marketing</span>
            <h1 className="text-4xl md:text-5xl font-bold mt-2 mb-6">
              <span className="text-gradient">HubSpot</span> Integration
            </h1>
            <p className="text-lg text-muted-foreground mb-8">
              Automate your marketing workflows with HubSpot integration. Connect your marketing automation, email campaigns, and lead management seamlessly.
            </p>
              ...
              <div className="p-6 rounded-2xl border border-border/50 bg-card/50 backdrop-blur-xl">
                ...
                <ol className="space-y-4">
                  <li className="flex items-start gap-3">
                    ...
                    <span className="text-muted-foreground">Connect your HubSpot account</span>
                  </li>
                  <li className="flex items-start gap-3">
                    ...
                    <span className="text-muted-foreground">Map your contact and company fields</span>
                  </li>
                  <li className="flex items-start gap-3">
                    ...
                    <span className="text-muted-foreground">Configure automation triggers</span>
                  </li>
                  <li className="flex items-start gap-3">
                    ...
                    <span className="text-muted-foreground">Launch integrated marketing campaigns</span>
                  </li>
                </ol>
              </div>
            </div>
            ...
            <div className="flex gap-4">
              <Link to="/integrations/get-started?integration=HubSpot">
                <Button size="lg" className="gap-2">
                  Get Started <Zap className="w-4 h-4" />
                </Button>
              </Link>
              <Link to="/integrations/docs?integration=HubSpot">
