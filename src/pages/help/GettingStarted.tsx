...
const articles = [
  ...
  { title: "System requirements", slug: "system-requirements", description: "Browser and device compatibility information.", content: "<h2>System Requirements</h2><p>EVO Grow works best with:</p><ul><li><strong>Browsers</strong> - Chrome, Firefox, Safari, or Edge (latest 2 versions)</li><li><strong>Screen Resolution</strong> - 1280x720 or higher recommended</li><li><strong>Internet</strong> - Stable broadband connection</li><li><strong>Mobile</strong> - iOS 14+ or Android 10+</li></ul><p>JavaScript must be enabled for full functionality.</p>", readTime: "2 min read" },
];
