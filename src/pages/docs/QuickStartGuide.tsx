        ...
        <div className="container px-4 max-w-4xl">
          ...
          <div className="prose prose-lg dark:prose-invert max-w-none">
            <p className="text-lg text-muted-foreground mb-8">
              Get up and running with EVO Grow in just a few minutes. This guide will walk you through the essential steps to start using our platform.
            </p>
            
            <h2 className="text-2xl font-semibold mt-8 mb-4">Step 1: Create Your Account</h2>
            <p className="text-muted-foreground mb-4">
              Sign up for EVO Grow using your business email. You'll receive a confirmation email to verify your account.
            </p>
            ...
            <p className="text-muted-foreground mb-4">
              Integrate your existing tools like CRM, analytics platforms, and financial software to give EVO Grow a complete picture of your business.
            </p>
            ...
            <div className="p-6 rounded-xl bg-primary/10 border border-primary/20 mt-8">
              ...
              <p className="text-muted-foreground">
                Our support team is available 24/7. Contact us at support@evogrow.com or visit our Help Center.
              </p>
            </div>
          </div>
        </div>
