...
export const planLimitsMap: Record<string, PlanLimits> = {
  ...
  ultimate: {
    ...
    label: "Ultimate Plan",
    price: "$5,999/mo",
    tagline: "Total marketing intelligence — fully operational.",
    aiGenerations: 999999,
    maxCampaigns: "Unlimited",
    maxFunnels: "Unlimited",
    ...
    contentTypes: [
      "blog-seo", "multi-ad", "email-campaign", "sales-page",
      "funnel-script", "social-batch", "landing", "multi-language",
      "investor-report", "market-analysis", "video-script", "brand-story",
      "product-description",
    ],
    quickActions: [
      { id: "ai-content", label: "AI Content Engine", icon: "Sparkles" },
      { id: "campaign", label: "Launch Campaign", icon: "Target" },
      { id: "automation", label: "Create Automation", icon: "Workflow" },
      { id: "market-intel", label: "Market Intelligence", icon: "Search" },
      { id: "multi-brand", label: "Multi-Brand Manager", icon: "Building2" },
      { id: "strategic-advisor", label: "AI Strategic Advisor", icon: "Brain" },
      { id: "asset-library", label: "Asset Library", icon: "FolderOpen" },
      { id: "revenue-forecast", label: "Revenue Forecast", icon: "TrendingUp" },
      { id: "cross-dept", label: "Command Dashboard", icon: "BarChart3" },
    ],
    hasABTesting: true,
    hasAdvancedAnalytics: true,
    hasAutomation: true,
    ...
    hasMultiLanguageContent: true,
    hasPhoneSupport: true,
    supportLevel: "24/7 Dedicated Priority",
    upgradeTo: null,
  },
};
