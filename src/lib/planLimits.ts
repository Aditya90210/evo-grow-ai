...
export const planLimitsMap: Record<string, PlanLimits> = {
  ...
  enterprise: {
    ...
    price: "$2,999/mo",
    tagline: "Enterprise systems operational.",
    aiGenerations: 999999,
    maxCampaigns: "Unlimited",
    maxFunnels: "Unlimited",
    maxIntegrations: 500,
    ...
    contentTypes: [
      "blog-seo", "multi-ad", "email-campaign", "sales-page",
      "funnel-script", "social-batch", "landing", "multi-language",
      "investor-report", "market-analysis",
    ],
    quickActions: [
      { id: "ai-content", label: "Generate Enterprise AI Content", icon: "Sparkles" },
      { id: "campaign", label: "Launch Multi-Channel Campaign", icon: "Target" },
      { id: "automation", label: "Create Strategic Automation", icon: "Workflow" },
      { id: "cross-dept", label: "Cross-Department Dashboard", icon: "BarChart3" },
      { id: "revenue-forecast", label: "Revenue Scenario Simulation", icon: "TrendingUp" },
      { id: "crm", label: "Enterprise CRM", icon: "Users" },
      { id: "integrations", label: "Global Integrations Hub", icon: "Plug" },
      { id: "compliance", label: "Compliance & Security", icon: "Shield" },
      { id: "custom-ai", label: "Custom AI Model", icon: "Brain" },
    ],
    hasABTesting: true,
    hasAdvancedAnalytics: true,
    hasAutomation: true,
